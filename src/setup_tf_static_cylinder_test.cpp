...
private:
    ...
    std::vector<std::string> base_link_transform;
...
public:
    StaticTransforms() : nh_("~")
    {
        ...
        */
        ...
        //===== World to Markers =====//
        // currently not using markers

        //====================================================================//
        // Forklift Frames
        //====================================================================//
        base_link_transform.push_back("base_link");
        base_link_transform.push_back("forklift.yaml");
        frame_catalog.push_back(base_link_transform);
